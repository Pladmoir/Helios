...
int LoopSlideIndex[2] = {0, 4}; // index for LoopSlidePiece array depending on side
int LoopNonSlidePiece[6] = {wH, wK, 0, bH, bK, 0};
...
int NumDir[13] = {0, 0, 8, 4, 4, 8, 8, 0, 8, 4, 4, 8, 8}; // number of possible directions by piece type
